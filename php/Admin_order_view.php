            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <center>
                            <h1 style="font-weight:900;font-size:35px;color:red">ORDER
                                DETAILS</h1>
                            ...
                            <table
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td
                                                style="font-weight:900; color: red; font-size : 25px;"><?php
                                                echo $a;?></td>
                                            <td
                                                style="font-weight:900; color: blue; font-size : 25px;"><?php
                                                echo $pmt_id?></td>
                                            <td
                                                style="font-weight:900; color: red; font-size : 25px;"><?php
                                                echo $crd_no?></td>
...
<link	rel="stylesheet"  href="htpts://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.c ss"/>-->
                                            <script
                                                src="<?php echo $slct_tw_js?>"></script>
                                            <script>
