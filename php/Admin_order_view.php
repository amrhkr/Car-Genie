...
<center>
<h1	style="font-weight:900;font-size:35px;color:red">ORDER DETAILS</h1>
...
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $crd_no?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $add;?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $cus_id?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $purch_pric?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $pur_dte?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $purch_tme?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $purch_qunty?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $vchl_id?></td>
<td style="font-weight:900; color: red; font-size : 25px;"><?php echo $vchl_nme?></td>
...
=====-->
<!-- Dashboard js -->
<script src="<?php echo $dsh_dhs_js?>" type="text/javascript"></script> <!-- End Theme  label Script
================================================================
=====-->
<!--
