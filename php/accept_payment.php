...
$cur_dt_dmy=date("d-m-Y"); $cur_tm=date("H:i:s"); $cur_dt_ymd=date("Y-m-d");  include("conn.php");
...
<p style="font-size: 50px;font-weight: bold;color: #e70b3e;text-align: center;">YOUR  PAYMENT IS SUCCESSFULL</p> <center><img src="image/sussfull.png"></center>
</div>
<div class="modal-footer">
<center><a href="all_cars_ctgry.php" class="btn btn-primary" style="width: 100%;  height: 100px;font-weight: bold;font-size: 50px;" target="_blank">VIWS  RECEIPT</a></center>
</div>
