...
<head>
    <title>PURCHASE CAR - login</title>
...
<body>
    ...
    <div class="frame2">
        <center>
            <form name="login" method="post" action="admin_login_slct.php">
                <h1>Login here</h1>
                <h4>ADMIN ID : &nbsp; <input type="text" name="user" placeholder="User id"></h4>
                <h4>ADMIN NAME : &nbsp; <input type="text" name="user" placeholder="User id"></h4>
                <h4>PASSWORD : <input type="password" name="pass" placeholder="Password"></h4>
                <h4>CONTACT: &nbsp; <input type="text" name="user" placeholder="User
id"></h4>
